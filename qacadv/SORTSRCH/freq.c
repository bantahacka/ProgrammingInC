 ...
 *                them into an array of pointers. Only unique words are
 *                stored (requiring the use of bsearch and qsort).
 *
 *  NOTE:         When you have everything working, you may like to include
 *                the timer stuff from the arrays labs to see how long it
 *                all takes. This is because this problem (sorting a list
 *                of words) will be revisited in the linked list and trees
 *                exercises.
 *
 *********************************************************************/
